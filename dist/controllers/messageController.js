...
var sendMessage = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, sender, recipient, content, hasAttachment, newMessage, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, sender = _a.sender, recipient = _a.recipient, content = _a.content, hasAttachment = _a.hasAttachment;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
            ...
            case 2:
                _b.sent();
                return [2 /*return*/, res.status(201).json({ message: newMessage })];
            case 3:
                err_2 = _b.sent();
                console.error(err_2);
                return [2 /*return*/, res
                        .status(500)
                        .json({ message: "Failed to send message", error: err_2 })];
